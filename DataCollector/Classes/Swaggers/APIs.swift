...
open class DataCollectorAPI {
    open static var basePath = "https://api.knetik.io"
...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:Any]?, isBody: Bool, headers: [String:String] = [:]) {
        ...
        addHeaders(DataCollectorAPI.customHeaders)
    }
    ...
    open func addCredential() -> Self {
        self.credential = DataCollectorAPI.credential
        return self
    }
}
